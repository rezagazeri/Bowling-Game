...
var BounosRequired = /** @class */ (function () {
    ...
    BounosRequired.prototype.checkBonus = function () {
        var type;
        if ((this._bounosRequired.throws.length === 1) && (this._bounosRequired.completeFrameScore === 10))
            type = config_1.BonusType.strick;
        else if ((this._bounosRequired.throws.length > 1) && (this._bounosRequired.completeFrameScore === 10))
